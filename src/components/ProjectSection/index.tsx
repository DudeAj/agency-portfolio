...
const ProjectSection: React.FC = () => {
  ...
  return (
    <section className="flex justify-center md:my-32 my-16">
      <div className="w-11/12 md:w-10/12 rounded-2xl">
          ...
          <div className="flex overflow-hidden bg-utility-dark-blue flex-col w-full rounded-2xl max-md:max-w-full">
            <div className="border border-solid border-slate-900 rounded-md max-md:max-w-full">
              <div className="relative">
                <div className="flex flex-col w-[33%] -top-36 md:top-0 left-0 bottom-0 absolute">
                  <img
                    loading="lazy"
                ...
                <div className="flex flex-col ml-5">
                  <div className="flex z-10 justify-center flex-col items-center my-24 text-lg font-medium text-white">
                    ...
                    <p className="mt-4 text-center text-slate-500 w-full md:w-1/2">
                      Contact us today to start crafting your exceptional and
                      customized website solution.
                    </p>
                    <div className="flex flex-col md:flex-row gap-1 md:gap-5 items-center w-full justify-center mb-14">
                ...
                <div className="flex flex-col w-[33%] absolute -top-36 md:top-0 -right-5 bottom-0">
                  <img
                    loading="lazy"
